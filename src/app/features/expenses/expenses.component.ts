      ...
      <div class="date-range">
        <label>
          ...
          <input
            ...
            (input)="dateRange.setStart($any($event.target).value)"
        ...
        <label>
          ...
          <input
            ...
            (input)="dateRange.setEnd($any($event.target).value)"
            aria-label="End date"
          />
        </label>
      </div>
...
export class ExpensesComponent {
  ...
  readonly rangeStart = computed(() => fromInputDateString(this.dateRange.startDateStr()) ?? this.defaultRange.start);
  readonly rangeEnd = computed(() => fromInputDateString(this.dateRange.endDateStr()) ?? this.defaultRange.end);
