...
describe('CategorySummaryComponent', () => {
  ...
  beforeEach(async () => {
    ...
    storage.setJournalLines([
      ...
      { id: 'l3', transactionId: '2', accountId: 'Food', debit: 30, credit: 0 },
      { id: 'l4', transactionId: '2', accountId: 'CC-1', debit: 0, credit: 30 },
      { id: 'l5', transactionId: '3', accountId: 'Medical', debit: 100, credit: 0 },
      { id: 'l6', transactionId: '3', accountId: 'Chk-1', debit: 0, credit: 100 },
    ]);
  ...
  it('should show empty state when no expenses', () => {
    storage.clear();
    storage.setAccounts([{ id: 'Food', type: 'expense' }]);
    storage.setTransactions([]);
    storage.setJournalLines([]);
    expenseService.loadFromStorage();
    fixture.detectChanges();
